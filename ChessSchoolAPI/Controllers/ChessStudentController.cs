...
namespace ChessSchoolAPI.Controllers
{
    ...
    public class ChessStudentsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ChessStudent>> Create(ChessStudent newStudent, [FromServices] KafkaProducerService producer)
        {
            ...
            var created = await _studentService.Create(newStudent, userId);
